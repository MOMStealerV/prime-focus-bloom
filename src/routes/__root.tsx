...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PrimeFlow — AI focus & digital wellbeing" },
      {
        name: "description",
        content:
          "PrimeFlow helps you cut distractions, build focus habits and design a calmer, more productive day.",
      },
      { name: "author", content: "PrimeFlow" },
      { property: "og:title", content: "PrimeFlow — AI focus & digital wellbeing" },
      {
        property: "og:description",
        content: "Cut distractions, build focus habits and design a calmer day.",
      },
